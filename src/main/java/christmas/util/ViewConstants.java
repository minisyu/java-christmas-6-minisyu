...
public class ViewConstants {
    ...
    public static final String ZERO_WON = ZERO_AMOUNT + WON;

    public static final String COUNT = "개";
    public static final String NONE = "없음";

    public static final String NEGATIVE_NUMBER_FORMAT = "-%s";
    public static final String LABEL_WITH_NEGATIVE_NUMBER_FORMAT = "%s: -%s";

    public static final String EVENT_RESERVATION_FRAME = """
